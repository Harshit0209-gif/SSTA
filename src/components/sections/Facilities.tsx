...
const facilities = [
  ...
  },
  {
    ...
    description:
      "A resident first-aid unit with trained medical personnel ensures trainee safety throughout all physical and field training activities.",
    image:
      "https://images.pexels.com/photos/30902100/pexels-photo-30902100.jpeg?auto=compress&cs=tinysrgb&w=600",
  },
  {
    icon: Package,
