...
const instructors = [
  {
    name: 'Subedar Major L. Biakhlua (Retd.)',
    rank: 'Subedar Major',
    unit: '11 Gorkha Rifles',
    service: '29+ Years',
    specialization: 'Close Protection & Threat Assessment',
    image:
      'https://images.pexels.com/photos/10852920/pexels-photo-10852920.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    name: 'Naib Subedar Md. Shakil Khan (Retd.)',
    rank: 'Naib Subedar',
    unit: 'Assam Regiment',
    service: '24 Years',
    specialization: 'Physical Training & Combat Fitness',
    image:
      'https://images.pexels.com/photos/4891762/pexels-photo-4891762.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    name: 'Naib Subedar C.B. Thapa (Retd.)',
    rank: 'Naib Subedar ',
    unit: 'Sikh Light Infantry',
    service: '22 Years',
    specialization: 'Patrol Tactics & Perimeter Security',
    image:
      'https://images.pexels.com/photos/5790891/pexels-photo-5790891.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
];
    ...
    <section className='py-24 lg:py-32 bg-[#F7F6F3]'>
      <div className='max-w-7xl mx-auto px-6 lg:px-8'>
                ...
                <div className='flex items-center gap-1 mb-3'>
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      size={13}
                      className='fill-[#C89B3C] text-[#C89B3C]'
                    />
                  ))}
                </div>
        ...
        >
          ...
          <span className='text-[#1F2937] font-medium'>200 years</span> of
