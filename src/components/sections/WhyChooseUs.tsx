...
const features = [
  {
    ...
    description:
      "Our curriculum is built on the same rigorous standards that govern India's armed forces — ensuring trainees are prepared for any situation.",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description:
      "trainees receive industry-recognised certifications that open doors with Northeast India's top security agencies and corporates.",
  },
  {
    icon: BookOpen,
