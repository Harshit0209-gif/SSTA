...
const contactInfo = [
  {
    ...
    value: "Sainik Surakhsa Training Academy\nSilpukhuri, Guwahati — 781 003\nAssam, India",
  },
  {
    icon: Phone,
    label: "Phone",
                ...
                return (
                  <div key={item.label} className="flex gap-4">
                    ...
                    <div>
                      ...
                      {item.value.split("\n").map((line, i) => (
                        <p key={i} className="text-[16px] text-white/85 leading-relaxed">
                          {line}
                        </p>
                      ))}
                    </div>
            ...
            <div className="mt-8 rounded-xl overflow-hidden h-40 bg-[#2D3748] relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <a
                    href="https://maps.google.com/?q=Silpukhuri+Guwahati"
                    target="_blank"
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="security-guard">Security Guard Training</option>
