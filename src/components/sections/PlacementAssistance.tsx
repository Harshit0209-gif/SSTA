...
const services = [
  {
    ...
    description:
      "Our team helps graduates translate their military service records into professional resumes aligned with private sector expectations.",
  },
  {
    icon: Users,
    title: "Industry Connections",
    description:
      "Through our network across Northeast India, we facilitate introductions between qualified graduates and security agencies actively seeking personnel.",
  },
  {
    icon: Building2,
  ...
  },
  {
    ...
    description:
      "Mock interviews, grooming guidance, and professional conduct coaching ensure graduates present themselves with confidence and polish.",
  },
];
  ...
  return (
    <section id="placements" className="py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center" ref={ref}>
          {/* Left: content */}
          <motion.div
          ...
          >
            ...
            <p className="text-[#4B5563] text-[17px] leading-relaxed mb-8">
              We connect graduates with employers across Northeast India —
              including opportunities within the group&rsquo;s affiliated security
              company where applicable. However, placement outcomes depend on
              individual performance, market availability, and candidate
              preference. We provide the bridge; our graduates cross it on their
              own merit.
            </p>
          ...
          >
            ...
            <div className="absolute -left-6 top-1/3 bg-white border border-[#E5E7EB] rounded-2xl p-6 shadow-xl">
              ...
              <div className="text-[14px] text-[#4B5563] font-medium leading-tight max-w-[130px]">
                of graduates find placement within 90 days
              </div>
            </div>
