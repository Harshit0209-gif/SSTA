...
import {
  ClipboardList, UserCheck, FileCheck, Dumbbell,
  ClipboardCheck, Award, Briefcase,
} from "lucide-react";
...
const steps = [
  ...
  },
  {
    ...
    title: "Certification",
    description:
      "Successful graduates receive industry-recognised certificates. A formal certification ceremony marks the completion.",
  },
  {
    icon: Briefcase,
    number: "07",
    ...
    description:
      "Our placement cell connects graduates with leading security agencies and corporates across Northeast India.",
  },
];
                  ...
                  <div className={`flex-1 ${isLeft ? "lg:text-right" : "lg:text-left"} text-left`}>
                    <div
                      className={`bg-[#F7F6F3] border border-[#E5E7EB] rounded-2xl p-8 hover:shadow-md hover:border-[#A32020]/20 transition-all duration-300 ${
                        isLeft ? "lg:ml-auto lg:max-w-md" : "lg:mr-auto lg:max-w-md"
                      }`}
                    >
